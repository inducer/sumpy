...
def test_helmholtz_2D():
    ...
    derivs = [derivs[i].subs(var[0], x_coord).subs(var[1], y_coord).evalf() for i in range(6)]
    ...
    assert abs(check_2_s.subs(var[0],x_coord).subs(var[1],y_coord)) <= 1e-12
    assert abs(check_3_s.subs(var[0],x_coord).subs(var[1],y_coord)) <= 1e-12
    assert abs(check_4_s.subs(var[0],x_coord).subs(var[1],y_coord)) <= 1e-12
    assert abs(check_5_s.subs(var[0],x_coord).subs(var[1],y_coord)) <= 1e-12
